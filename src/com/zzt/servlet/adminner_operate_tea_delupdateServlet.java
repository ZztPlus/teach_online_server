...
@WebServlet(name = "adminner_operate_tea_delupdateServlet",urlPatterns = "/adminner_operate_tea_delupdate")
public class adminner_operate_tea_delupdateServlet extends HttpServlet {
    @Override
    //修改教师数据
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("update tea_login set name=?,pw=?,level=?,age=?,sex=?,phonenumber=? where gonghao=?");
            ...
            writer.print("教师信息修改成功，请及时通知!");
            return;
        } catch (Exception e) {
            e.printStackTrace();
        }
        writer.print("教师信息修改失败！");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Connection connection = SqlConnection.getConnection();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("delete from tea_login where gonghao=? ");
